...
- **The published artifact has no auth or rate limiting.** Anyone with the link can run the agents. Fine for validation; a production build moves API calls behind a serverless function.
